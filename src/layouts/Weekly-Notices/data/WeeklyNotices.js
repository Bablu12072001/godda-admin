...
const WeeklyNoticeList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://vkfpe87plb.execute-api.ap-south-1.amazonaws.com/production/jmoa_weekly_notice_all_data", {
          headers: {
  ...
  const handleDelete = async (noticeId) => {
    try {
      ...
      await axios.delete(`https://vkfpe87plb.execute-api.ap-south-1.amazonaws.com/production/jmoa_weekly_notice_delete`, {
        data: { id: noticeId },
        headers: {
          Authorization: accessToken(),
        },
...
export default WeeklyNoticeList;
